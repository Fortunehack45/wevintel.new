...
import {
    ...
    SiDocker, SiKubernetes, SiAmazonaws, SiGooglecloud, SiMicrosoftazure, SiVercel, SiNetlify, SiHeroku,
...
const techIcons: { [key: string]: React.ElementType } = {
    ...
    // Hosting & CDN
    'aws': SiAmazonaws, 'google cloud': SiGooglecloud, 'azure': SiMicrosoftazure, 'vercel': SiVercel, 'netlify': SiNetlify,
