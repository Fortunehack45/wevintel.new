                ...
                <CardHeader>
                    <div className="flex flex-col items-center gap-2 text-center">
                        <div className="flex items-center gap-2 overflow-hidden">
                           <Image src={`https://www.google.com/s2/favicons?domain=${item.domain1}&sz=32`} alt={`${item.domain1} favicon`} width={24} height={24} className="rounded-md flex-shrink-0 bg-slate-100 dark:bg-white/10 p-0.5" crossOrigin="anonymous"/>
                           <CardTitle className="truncate text-sm font-semibold">{item.domain1}</CardTitle>
                        </div>
                        <Scale className="h-5 w-5 text-muted-foreground my-1" />
                        <div className="flex items-center gap-2 overflow-hidden">
                           <Image src={`https://www.google.com/s2/favicons?domain=${item.domain2}&sz=32`} alt={`${item.domain2} favicon`} width={24} height={24} className="rounded-md flex-shrink-0 bg-slate-100 dark:bg-white/10 p-0.5" crossOrigin="anonymous"/>
                           <CardTitle className="truncate text-sm font-semibold">{item.domain2}</CardTitle>
                        </div>
                    </div>
