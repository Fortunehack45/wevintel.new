  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl space-y-8">
      ...
      <Card className="glass-card">
        <CardHeader>
          <CardTitle>Last Updated: October 31, 2025</CardTitle>
        </CardHeader>
        <CardContent className="prose prose-sm sm:prose-base lg:prose-lg dark:prose-invert max-w-none text-muted-foreground">
          <h2>ARTICLE I: PRELIMINARY PROVISIONS AND DEFINITIONS</h2>
          <h3>1.1 Introduction and Scope of Agreement</h3>
          <p>
            1.2 These Terms and Conditions of Service (hereinafter referred to as “the Terms”, “this Agreement”, or “these Terms and Conditions”) constitute a legally binding contract between WebIntel, its operators, administrators, and affiliated entities (hereinafter collectively referred to as “the Service Provider”, “We”, “Us”, or “Our”) and any individual or entity accessing, browsing, or utilizing the WebIntel website analysis and intelligence tool platform (hereinafter referred to as “the User”, “You”, “Your”, or “the Client”).
          </p>
          <p>
            By accessing, registering for, or utilizing any feature, function, or service provided through the WebIntel platform (hereinafter referred to as “the Platform”, “the Service”, or “the Application”), You hereby acknowledge that You have read, understood, and unconditionally agree to be bound by all terms, conditions, obligations, representations, and warranties set forth herein. This Agreement shall govern Your use of the Service in its entirety and supersedes all prior agreements, understandings, negotiations, or communications, whether written or oral, relating to the subject matter hereof.
          </p>
          <h3>1.3 Definitions and Interpretation</h3>
          <p>1.4 For the purposes of this Agreement, unless the context otherwise requires, the following terms shall have the meanings ascribed to them below:</p>
          <p>
            <strong>“Account”</strong> means the registered user profile created by the User through the Firebase authentication system, which enables access to the Platform’s features and functionalities.
          </p>
          <p>
            <strong>“Analysis”</strong> means the comprehensive examination, evaluation, and report generation concerning any target website’s performance metrics, security configurations, technology stack, hosting infrastructure, and related intelligence data.
          </p>
          <p>
            <strong>“Content”</strong> means all data, information, text, graphics, images, reports, analyses, recommendations, and other materials generated by or through the Platform, whether created by the Service Provider, artificial intelligence systems, or derived from third-party data sources.
          </p>
          <p>
            <strong>“Intellectual Property Rights”</strong> means all patents, rights to inventions, copyright and related rights, trademarks, trade names, domain names, rights in get-up, goodwill and the right to sue for passing off, rights in designs, rights in computer software, database rights, rights to use and protect the confidentiality of confidential information including know-how and trade secrets, and all other intellectual property rights, in each case whether registered or unregistered and including all applications and rights to apply for and be granted renewals or extensions of, and rights to claim priority from, such rights and all similar or equivalent rights or forms of protection which subsist or will subsist now or in the future in any part of the world.
          </p>
          <p>
            <strong>“Local Storage”</strong> means the browser-based data storage mechanism employed by the Platform to store User analysis history, preferences, and related information exclusively within the User’s local computing device.
          </p>
          <p>
            <strong>“Personal Data”</strong> means any information relating to an identified or identifiable natural person, as defined under applicable data protection legislation, including but not limited to the Nigeria Data Protection Act 2023 and the General Data Protection Regulation (GDPR) where applicable.
          </p>
          <p>
            <strong>“Third-Party Services”</strong> means external application programming interfaces, data sources, and services utilized by the Platform, including but not limited to Google PageSpeed Insights, Google Gemini artificial intelligence services, ip-api.com, and Firebase authentication services.
          </p>
          <h3>1.3 Legal Capacity and Authority</h3>
          <p>
            By accepting these Terms, You represent and warrant that You possess the legal capacity and authority to enter into this binding Agreement. If You are accepting these Terms on behalf of a company, organization, or other legal entity, You represent and warrant that You have the requisite authority to bind such entity to these Terms, and in such case, “You” and “Your” shall refer to such entity. You further represent that You are at least eighteen years of age or have reached the age of majority in Your jurisdiction, whichever is greater, and are fully able and competent to enter into, abide by, and comply with the terms, conditions, obligations, affirmations, representations, and warranties set forth in these Terms.
          </p>
          <h2>ARTICLE II: CONSTITUTIONAL AND LEGAL FRAMEWORK</h2>
          <h3>2.1 Compliance with Nigerian Constitutional Provisions</h3>
          <p>
            The Service Provider acknowledges and commits to operating in full compliance with the Constitution of the Federal Republic of Nigeria 1999 (as amended), particularly with respect to the fundamental rights guaranteed under Chapter IV thereof. The Platform’s operations are conducted with due regard to:
          </p>
          <ul>
          ...
          <p>
            The Service Provider recognizes and undertakes to respect the principles enshrined in various United Nations instruments concerning human rights in the digital sphere, including:
          </p>
          <ul>
          ...
          <p>
            The Service Provider operates in strict compliance with the Nigeria Data Protection Act 2023 (NDPA), which establishes the legal framework for data protection in Nigeria. The Service Provider’s practices align with the NDPA’s principles of lawfulness, fairness, transparency, purpose limitation, data minimization, accuracy, storage limitation, integrity, and confidentiality. Where the Platform processes Personal Data of individuals located in the European Union, the Service Provider also ensures compliance with the General Data Protection Regulation (EU) 2016/679 (GDPR).
          </p>
          <h2>ARTICLE III: USER REGISTRATION AND ACCOUNT MANAGEMENT</h2>
          <h3>3.1 Account Creation and Authentication</h3>
          <p>
            To access certain features of the Platform, including but not limited to the ability to save analysis history and utilize comparison functionalities, You must create an Account through the Firebase authentication system integrated into the Platform. During the registration process, You agree to:
          </p>
          <ul>
          ...
          <p>
            The Service Provider reserves the right, in its sole and absolute discretion, to suspend, terminate, or restrict access to Your Account, with or without notice, for any reason whatsoever, including but not limited to:
          </p>
          <ul>
          ...
          <p>
            Subject to Your strict compliance with these Terms and Conditions, the Service Provider grants You a limited, non-exclusive, non-transferable, non-sublicensable, revocable license to access and use the Platform solely for Your personal or internal business purposes in accordance with these Terms. This license does not include any right to:
          </p>
          <ul>
          ...
          <ul>
            <li>Client-Side Data Storage: All analysis history, comparison data, User preferences, and related information generated through Your use of the Platform are stored exclusively within Your browser’s Local Storage mechanism. This data remains on Your local computing device and is not transmitted to, stored on, or accessible by the Service Provider’s servers, except as may be necessary for the provision of specific services requested by You.</li>
            <li>No Server-Side Activity Logging: The Service Provider does not maintain server-side logs of User activities, including the specific URLs analyzed, the timing of such analyses, or the results obtained, except for minimal technical logs necessary to maintain system security and integrity.</li>
            <li>User Control and Data Portability: You maintain complete control over all data stored in Your browser’s Local Storage. You may export, delete, or otherwise manage this data at any time through the Platform's history management interface or through Your browser’s native data management tools.</li>
          </ul>
          ...
          <ul>
            ...
            <li>Right to Data Portability: You have the right to receive Your Personal Data in a structured, commonly used, and machine-readable format and to transmit such data to another controller where technically feasible.</li>
            <li>Right to Object: You have the right to object to processing of Your Personal Data where such processing is based on legitimate interests pursued by the Service provider or a third party.</li>
            <li>Right to Withdraw Consent: Where processing is based on Your consent, You have the right to withdraw such consent at any time, without affecting the lawfulness of processing based on consent before its withdrawal.</li>
          </ul>
          <p>
            To exercise any of these rights, You may contact the Service Provider using the contact information provided in Article XII hereof. The Service Provider shall respond to Your request within one month of receipt, or within such other timeframe as may be required by applicable data protection legislation.
          </p>
          <h3>6.5 Data Security Measures</h3>
          <p>
            The Service Provider implements appropriate technical and organizational measures to ensure a level of security appropriate to the risk of processing, taking into account the state of the art, the costs of implementation, and the nature, scope, context, and purposes of processing, as well as the risk of varying likelihood and severity for the rights and freedoms of natural persons. Such measures include:
          </p>
          <ul>
          ...
          <p>
            Notwithstanding these security measures, You acknowledge that no method of electronic transmission or storage is completely secure, and the Service Provider cannot guarantee absolute security of data transmitted to or stored by the Platform.
          </p>
          <h3>6.6 Data Breach Notification</h3>
          <p>
            In the event of a data breach that is likely to result in a risk to Your rights and freedoms, the Service Provider shall notify You of such breach without undue delay and, where feasible, within seventy-two hours of becoming aware of the breach, in accordance with the requirements of the Nigeria Data Protection Act 2023. Such notification shall include, to the extent feasible:
          </p>
          <ul>
          ...
          <h2>ARTICLE VII: DISCLAIMERS AND WARRANTIES</h2>
          <h3>7.1 Service Availability Disclaimer</h3>
          <p>
            The Platform is provided on an “as is” and “as available” basis without warranties of any kind, either express or implied, to the fullest extent permissible under applicable law. The Service Provider does not warrant that:
          </p>
          <ul>
          ...
          <p>
            You acknowledge and agree that all information, data, analyses, reports, and recommendations provided through the Platform are derived from publicly available sources and Third-Party Services and are provided for informational purposes only. The Service Provider makes no representation or warranty concerning the accuracy, reliability, completeness, or timeliness of such information.
          </p>
          <p>
            Website performance metrics, security assessments, technology identifications, traffic estimations, and other analytical outputs are subject to inherent limitations, measurement errors, and methodological constraints. Such outputs should not be relied upon as the sole basis for any material business, technical, legal, or financial decision without independent verification and professional consultation.
          </p>
          <p>
            The Service Provider expressly disclaims any liability for decisions made or actions taken in reliance upon information provided through the Platform.
          </p>
          <h3>7.3 Artificial Intelligence Content Disclaimer</h3>
          <p>
            Content generated through artificial intelligence services, including but not limited to summaries, recommendations, traffic estimations, and technology identifications, is produced by machine learning models that may generate inaccurate, incomplete, biased, or misleading information. Such AI-generated content represents probabilistic outputs based on pattern recognition and statistical inference and should not be treated as factual statements or expert opinions.
          </p>
          <p>
          ...
          <p>
            The Service Provider expressly disclaims any liability for consequences arising from Your failure to obtain appropriate professional advice or from Your reliance upon information provided through the Platform as a substitute for professional consultation.
          </p>
          <h2>ARTICLE VIII: LIMITATION OF LIABILITY AND INDEMNIFICATION</h2>
          ...
          <p>
            Whether based on warranty, contract, tort (including negligence), product liability, or any other legal theory, and whether or not the Service Provider has been informed of the possibility of such damage, even if a limited remedy set forth herein is found to have failed of its essential purpose.
          </p>
          ...
          <p>
            The Service Provider reserves the right to assume the exclusive defense and control of any matter subject to indemnification by You, in which event You shall cooperate fully with the Service Provider in asserting any available defenses. You shall not settle any claim subject to this indemnification provision without the Service Provider’s prior written consent.
          </p>
          <h3>8.5 Force Majeure</h3>
          <p>
            The Service Provider shall not be liable for any failure or delay in performing its obligations under these Terms where such failure or delay results from any cause beyond the Service Provider’s reasonable control, including but not limited to acts of God, war, terrorism, civil unrest, labor disputes, epidemics, pandemics, government actions, embargoes, fires, floods, earthquakes, accidents, strikes, shortages of transportation, facilities, fuel, energy, labor, or materials, failure of Third-Party Services, denial of service attacks or other malicious cyber activities, or failure of the internet or other communications infrastructure (each, a "Force Majeure Event").
          </p>
          <p>
            In the event of a Force Majeure Event, the Service Provider’s obligations shall be suspended for the duration of such event, and the Service Provider shall be entitled to a reasonable extension of time for performance. If a Force Majeure Event continues for a period exceeding ninety days, either party may terminate this Agreement upon written notice to the other party without liability.
          </p>
          <h2>ARTICLE IX: TERMINATION AND SUSPENSION</h2>
          <h3>9.1 Termination by User</h3>
          <p>
            You may terminate Your relationship with the Service Provider at any time by discontinuing Your use of the Platform and, if You have created an Account, by deleting Your Account through the Platform’s account management interface or by contacting the Service Provider to request Account deletion. Upon such termination, Your license to use the Platform shall immediately terminate.
          </p>
          <p>
            You acknowledge that data stored in Your browser’s Local Storage will persist until You manually delete it through the Platform’s history management interface or Your browser’s data management tools. The Service Provider recommends that You delete all Local Storage data before ceasing use of the Platform if You wish to remove all traces of Your Platform usage from Your device.
          </p>
          <h3>9.2 Termination by Service Provider</h3>
          <p>
            The Service Provider may, in its sole and absolute discretion, terminate or suspend Your access to all or part of the Platform, with or without cause, with or without notice, effective immediately. Without limiting the foregoing, the Service Provider may terminate or suspend Your access for:
          </p>
          <ul>
            <li>Violation of any provision of these Terms and Conditions.</li>
          ...
          <p>
            Upon termination of Your access by the Service Provider, Your right to use the Platform shall immediately cease, and You shall immediately discontinue all use thereof.
          </p>
          <h3>9.3 Effect of Termination</h3>
          <p>
            Upon termination of Your access to the Platform for any reason:
          </p>
          <ul>
          ...
          <p>
            Notwithstanding the foregoing, where modifications to these Terms materially affect Your rights or obligations in a manner that would require Your express consent under applicable data protection legislation, the Service Provider shall obtain Your affirmative consent to such modifications before they become effective as to You. In such circumstances, You will be presented with the modified Terms upon Your next access to the Platform and will be required to accept such Terms before continuing to use the Platform.
          </p>
          <p>
            Your refusal to accept material modifications that require Your consent will result in the termination of Your access to the Platform, effective upon such refusal. The Service Provider shall not be liable for any consequences arising from Your decision to refuse to accept modified Terms.
          </p>
          <h3>10.3 Modifications to Service Features</h3>
          <p>
            The Service Provider reserves the right to modify, suspend, or discontinue any aspect of the Platform, including any features, functionality, or content, temporarily or permanently, with or without notice to You. The Service Provider may undertake such modifications for any reason, including but not limited to technical requirements, business considerations, changes to Third-Party Services, legal or regulatory requirements, or security concerns.
          </p>
          <p>
          ...
          <p>
            Where the Service Provider determines that notice of modifications to these Terms or the Platform is appropriate, such notice may be provided through any of the following methods, at the service Provider's discretion:
          </p>
          <ul>
          ...
          <p>
            You acknowledge that You are responsible for ensuring that the email address associated with Your Account is current and accurate and that You regularly check such email address for communications from the Service Provider. You further acknowledge that You are responsible for regularly reviewing these Terms to remain informed of any modifications.
          </p>
          <h2>ARTICLE XI: DISPUTE RESOLUTION AND GOVERNING LAW</h2>
          <h3>11.1 Governing Law and Jurisdiction</h3>
          <p>
            These Terms and Conditions, and any dispute or claim arising out of or in connection with them or their subject matter or formation, including non-contractual disputes or claims, shall be governed by and construed in accordance with the laws of the Federal Republic of Nigeria. The United Nations Convention on Contracts for the International Sale of Goods shall not apply to these Terms.
          </p>
          <p>
            Subject to the alternative dispute resolution provisions set forth in Section 11.2 below, the parties hereby submit to the exclusive jurisdiction of the courts of the Federal Republic of Nigeria for the resolution of any disputes arising out of or relating to these Terms, the Platform, or the relationship between You and the Service Provider. You hereby irrevocably waive any objection to venue in such courts and any claim that such courts constitute an inconvenient forum.
          </p>
          <h3>11.2 Mandatory Pre-Litigation Negotiation</h3>
          <p>
            In recognition of the principles of alternative dispute resolution encouraged under Nigerian law and in the interest of resolving disputes efficiently and cost-effectively, the parties agree that, prior to initiating any formal legal proceedings concerning any dispute, controversy, or claim arising out of or relating to these Terms or the breach, termination, enforcement, interpretation, or validity thereof, including the determination of the scope or applicability of this agreement to arbitrate or negotiate, the parties shall engage in good faith negotiations for a period of not less than sixty days following written notice by one party to the other party describing the nature of the dispute.
          </p>
          <p>
            During this sixty-day negotiation period, the parties shall make reasonable efforts to resolve the dispute through direct communication and shall designate representatives with authority to settle the dispute to participate in such negotiations. If the parties are unable to resolve the dispute through negotiation within such sixty-day period, either party may thereafter pursue any legal remedies available under these Terms or applicable law.
          </p>
          <h3>11.3 Arbitration Agreement</h3>
          <p>
            If the parties are unable to resolve any dispute through the mandatory pre-litigation negotiation process described in Section 11.2 above, the parties agree that any dispute, controversy, or claim arising out of or relating to these Terms or the breach, termination, enforcement, interpretation, or validity thereof shall be finally resolved by arbitration administered by the Lagos Court of Arbitration (International) or such other arbitration institution as the parties may mutually agree in writing, in accordance with the Arbitration and Conciliation Act (Cap A18) Laws of the Federation of Nigeria 2004 or any successor legislation.
          </p>
          <p>
            The arbitration shall be conducted by a single arbitrator appointed in accordance with the rules of the chosen arbitration institution. The seat of arbitration shall be Lagos, Nigeria, and the language of the arbitration shall be English. The arbitrator shall have the power to grant any legal or equitable remedy or relief that a court of the jurisdiction could order or grant, including but not limited to injunctive relief.
          </p>
          <p>
            The award rendered by the arbitrator shall be final and binding upon the parties and may be entered and enforced in any court of competent jurisdiction. Each party shall bear its own costs and expenses in connection with the arbitration, and the parties shall share equally the fees and expenses of the arbitrator and the arbitration institution, unless the arbitrator determines that a different allocation is appropriate based on the circumstances.
          </p>
          <h3>11.4 Exceptions to Arbitration</h3>
          <p>
            Notwithstanding the arbitration agreement set forth in Section 11.3 above, either party may seek injunctive relief or other equitable remedies in any court of competent jurisdiction to prevent the actual or threatened infringement, misappropriation, or violation of a party’s Intellectual Property Rights, trade secrets, or confidential information, or to enforce the provisions of these Terms relating to acceptable use, without first engaging in negotiation or arbitration.
          </p>
          <p>
            Additionally, either party may bring an action in small claims court or a court of similar jurisdiction for disputes falling within the jurisdiction of such court, provided that such action is brought in an individual capacity and not as part of a class action or representative proceeding.
          </p>
          <h3>11.5 Class Action Waiver</h3>
          <p>
            To the maximum extent permitted by applicable law, You agree that any dispute resolution proceeding, whether in arbitration or in court, shall be conducted solely on an individual basis and not as part of a class, consolidated, or representative action. Neither You nor the Service Provider shall participate in or be represented in any class, consolidated, or representative action concerning any dispute covered by these Terms. You and the Service Provider expressly waive any right to pursue claims on a class, consolidated, or representative basis.
          </p>
          <p>
            If any court or arbitrator determines that the class action waiver set forth in this section is void or unenforceable for any reason, or that an arbitration can proceed on a class basis, then the arbitration provision set forth in Section 11.3 above shall be deemed null and void in its entirety, and the parties shall be deemed to have not agreed to arbitrate disputes.
          </p>
          <h3>11.6 Limitation Period for Claims</h3>
          <p>
            To the maximum extent permitted by applicable law, any claim or cause of action arising out of or relating to these Terms or Your use of the Platform must be filed within one year after such claim or cause of action arose, failing which such claim or cause of action shall be permanently barred. This limitation period applies notwithstanding any statute of limitations or other law to the contrary. Where applicable law prohibits such a limitation period, the claim or cause of action must be filed within the shortest time period permitted by law.
          </p>
          <h2>ARTICLE XII: GENERAL PROVISIONS</h2>
          <h3>12.1 Entire Agreement</h3>
          <p>
            These Terms and Conditions, together with any privacy policy, acceptable use policy, or other supplemental terms or policies expressly incorporated by reference herein, constitute the entire agreement between You and the Service Provider concerning Your use of the Platform and supersede all prior or contemporaneous agreements, understandings, negotiations, representations, and warranties, both written and oral, between You and the Service Provider regarding such subject matter.
          </p>
          <p>
            You acknowledge and agree that You have not relied upon any statement, representation, warranty, or understanding that is not expressly set forth in these Terms, and You waive all rights and remedies that might otherwise be available to You under any legal theory based upon any such statement, representation, warranty, or understanding. No amendment to or modification of these Terms shall be binding unless made in writing and signed by an authorized representative of the Service Provider, except as provided in Article X concerning the Service Provider’s right to modify these Terms unilaterally.
          </p>
          <h3>12.2 Severability</h3>
          <p>
            If any provision of these Terms is held by a court of competent jurisdiction or arbitrator to be invalid, illegal, void, or unenforceable for any reason, such provision shall be eliminated or limited to the minimum extent necessary, and the remaining provisions of these Terms shall continue in full force and effect. The parties intend that each provision of these Terms shall be enforceable to the fullest extent permitted by applicable law.
          </p>
          <p>
